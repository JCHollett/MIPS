...
namespace CS3725 {
    ...
    public class CUI {
        ...
        internal void ExecuteMEMBufferDisplay( params ExecuteMEMBuffer[ ] buff ) {
            int offsetX = 91, offsetY = 27, labelWidth = 12, dataWidth=16;
        ...
        internal void MEMWBBufferDisplay( params MEMWBBuffer[ ] buff ) {
            int offsetX = 91, offsetY = 41, labelWidth = 12, dataWidth=16;
        ...
        /// </summary>
        internal void RenderMEMREG() {
            //Memory and Registers
            int LeftOffset = 0, TopOffset=49;
